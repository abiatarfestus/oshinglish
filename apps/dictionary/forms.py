        ...
        widgets = {
            "english_word": forms.TextInput(
                attrs={
                    ...
                    "type": "search",
                    "name": "search",
                    "placeholder": "Begin typing to English words...",
                    "hx-get": "/dictionary/ajax-search",
                    "hx-trigger": "keyup changed delay:500ms, search",
                    "hx-target": "#search-results",
                    # "hx-indicator": ".htmx-indicator",
                    "hx-headers": '{"english_word": "english_word"}',
                    "id": "englishWords",
                }
            ),
            "oshindonga_word": forms.TextInput(
            ...
            "part_of_speech": forms.TextInput(
                attrs={
                    "class": "form-control form-control-lg mb-3",
                    "id": "partsOfSpeech",
                }
            ),
            "synonyms": forms.TextInput(
                attrs={
                    "class": "form-control form-control-lg mb-3",
                    "multiple": "multiple",
                    "id": "synonyms",
